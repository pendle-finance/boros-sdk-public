...
export class ContractsFactory {
  ...
  getMarketHubContract(address: Address, walletClient?: WalletClient) {
    return new MarketHub(address, this.getRpcClientAndMulticall(), walletClient);
  }
  ...
  getERC20Contract(address: Address, _walletClient?: WalletClient) {
