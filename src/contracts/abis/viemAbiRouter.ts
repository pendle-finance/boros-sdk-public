    ...
    inputs: [
      {
        components: [
          {
            ...
            internalType: 'struct IRouterEventsAndTypes.OTCTradeReq',
            name: 'trade',
            type: 'tuple',
          },
          {
          ...
          },
          {
            ...
            internalType: 'struct IRouterEventsAndTypes.AcceptOTCTradeData',
            name: 'makerData',
            type: 'tuple',
          },
          {
        ...
        internalType: 'struct IRouterEventsAndTypes.ExecuteOTCTradeReq',
        name: 'req',
        type: 'tuple',
      },
    ],
    name: 'executeOTCTrade',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
