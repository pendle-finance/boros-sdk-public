export const CacheGetter = (): MethodDecorator => {
  ...
  return <T>(_target: object, _property: string | symbol, descriptor: TypedPropertyDescriptor<T>) => {
...
export const NoArgsCache = (): MethodDecorator => {
  const data = new WeakMap();
  return (_target: object, _property: string | symbol, descriptor: TypedPropertyDescriptor<any>) => {
