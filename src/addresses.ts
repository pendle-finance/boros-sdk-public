...
export const getHypeOftAddress = (): Address => {
  return env === 'production' ? PROD_ADDRESSES.HYPE_OFT_ADDRESS : DEV_ADDRESSES.HYPE_OFT_ADDRESS;
};
...
export function getBungeeApiUrl(): string {
  return env === 'production' ? 'https://backend.bungee.exchange' : 'https://public-backend.bungee.exchange';
}
