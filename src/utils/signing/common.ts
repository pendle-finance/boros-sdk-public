import { Address, Hex, encodeAbiParameters, keccak256, parseAbiParameters } from 'viem';
...
export function createPendleBorosRouterDomain(routerAddress?: Address, chainId?: number) {
  return {
    name: 'Pendle Boros Router',
    version: '1.0',
    chainId: BigInt(chainId ?? CHAIN_ID),
    verifyingContract: routerAddress ?? getRouterAddress(),
  } as const;
}
